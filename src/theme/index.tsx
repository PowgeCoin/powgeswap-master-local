...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    primary1: darkMode ? '#FFFFFF' : '#FFFFFF',
    primary2: darkMode ? '#FFFFFF' : '#FFFFFF',
    primary3: darkMode ? '#FFFFFF' : '#FFFFFF',
    primary4: darkMode ? '#FFE270' : '#FFE270',
    primary5: darkMode ? '#FFE270' : '#FFE270',

    // color text
    //primaryText1: darkMode ? '#000000' : '#CE4598',
